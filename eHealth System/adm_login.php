...
<body>
    ...
    <div class="form pushed_top">
        <div class="container">
            <h4 class="start-lg center-xs">Admin Login</h4>
                ...
                <div class="col s12 m8 pull-m2">
                    <form>
                        ...
                        <div class="input-field">
                            ...
                            <label for="idNo">Admin Login ID</label>
                        </div>
                        <div id="pass">
                            <div class="input-field">
                        ...
                        <div class="row middle-xs ">
                            <button type="submit" name="btn_login" id="btn_login" class="btn waves-effect waves-dark blue lighten-2 col s12 m4 round-btn">Login</button>
                             <div class="col s12 m8"><a href="login.php">Login as Patient</a></div>
                        </div>
                    </form>
                </div>
            </div>
